<section class='SectionGallery'>
    <div class='inner wrap fb fb--fd-col'>
        <h2 class='SectionGallery__title'>Gallery</h2>
        <hr>

        <div class='SectionGallery__scans fb fb--wr-wr fb--jc-c fb--ai-c'>
            <div class='SectionGallery__scan'>
                <iframe width="100%" height="100%" src="https://sketchfab.com/models/ae41a51c258946de94ca86a2d94aab37/embed" frameborder="0" allowfullscreen mozallowfullscreen="true" webkitallowfullscreen="true" onmousewheel=""></iframe>
            </div>
            <div class='SectionGallery__scan'>
